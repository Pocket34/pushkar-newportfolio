...
const TECHS = [
  {
    ...
    name: 'React',
    code: 'REACT',
    desc: 'Building responsive and interactive user interfaces with component-based architecture.',
    stat: 'Frontend',
    color: '#00d4ff',
  },
  {
    ...
    name: 'TypeScript',
    code: 'TS',
    desc: 'Developing scalable and type-safe web applications.',
    stat: 'Programming',
    color: '#00fff0',
  },
  {
    ...
    name: 'JavaScript',
    code: 'JS',
    desc: 'Core language for dynamic and modern web development.',
    stat: 'ES6+',
    color: '#00b8d4',
  },
  {
    ...
    name: 'HTML5 & CSS3',
    code: 'WEB',
    desc: 'Creating responsive layouts and modern user experiences.',
    stat: 'Frontend',
    color: '#00e5ff',
  },
  {
  ...
  },
  {
    ...
    name: 'Vercel',
    code: 'DEPLOY',
    desc: 'Deploying and hosting modern web applications.',
    stat: 'Cloud',
    color: '#4dd0e1',
  },
];
